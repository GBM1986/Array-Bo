...
myArray.push('element4', 'element5');
...
const myNextNumbers = myNumbers.map(myFunction)

function myFunction(num) {
  return num + 7;
}

const myLastNumbers = myNextNumbers.map(mySecoundFunction)

function mySecoundFunction(num) {
    return num * 12;
  }
